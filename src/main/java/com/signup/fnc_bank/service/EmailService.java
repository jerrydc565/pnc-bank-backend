...
public class EmailService {
    ...
    public void sendOtpEmail(String toEmail, String otp) {
        try {
            ...
            System.out.println("Using Mailjet API");
            System.out.println("=================================");
            
            String json = String.format(
                "{\"Messages\":[{\"From\":{\"Email\":\"pnconlinebanking67@gmail.com\",\"Name\":\"PNC Bank\"},\"To\":[{\"Email\":\"%s\"}],\"Subject\":\"PNC Bank - Your Login Verification Code\",\"HTMLPart\":\"<h2>Hello,</h2><p>Your One-Time Password (OTP) for PNC Bank login is:</p><h1 style='color: #0066cc; font-size: 32px;'>%s</h1><p>This code will expire in 5 minutes.</p><p>If you did not request this code, please ignore this email.</p><p>Thank you,<br>PNC Bank Security Team</p>\"}]}",
                toEmail, otp
            );
